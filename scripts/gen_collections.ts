...
export function generateCollectionData(geoEventRefs: string[] = []): {
	...
	const themes = ['Urban Planning', 'Recreation', 'Transportation', 'Environmental', 'Cultural Heritage']
	...
	const metadata: CollectionMetadata = {
		...
		license: faker.helpers.arrayElement(['CC-BY-4.0', 'CC-BY-SA-4.0', 'CC0-1.0', 'MIT']),
		tags: [
	...
	const spread = 0.2
	const bbox = [baseCity.lon - spread, baseCity.lat - spread, baseCity.lon + spread, baseCity.lat + spread]
