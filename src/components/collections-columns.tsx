...
export const createCollectionColumns = (
...
): ColumnDef<CollectionRowData>[] => [
  {
    ...
    header: "Collection",
    cell: ({ row }) => {
      const { collection, collectionName, datasetCount, referencedEvents } =
        row.original;
      ...
      return (
        <div className="flex items-center gap-1">
          <Button
            ...
            onClick={() =>
              context.onZoomToCollection?.(collection, referencedEvents)
            }
          ...
          <Button
            ...
            variant="outline"
            onClick={() =>
              context.onInspectCollection?.(collection, referencedEvents)
            }
