...
import { closestVertex, isValidPosition, nearestPointOnLine, pixelDistance } from '../utils/geometry';
...
export class SnapManager implements IManager {
	...
	constructor(snapDistance: number = 10, snapToVertices: boolean = true, snapToEdges: boolean = true) {
