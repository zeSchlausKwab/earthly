...
export async function fetchGeoJsonPayload(url: string): Promise<{ payload: any; size?: number; mimeType?: string }> {
...
export function sanitizeEditorProperties(props?: Record<string, any>): Record<string, any> | undefined {
...
export function extractCollectionMeta(collection: FeatureCollection): CollectionMeta {
	...
	if (typeof properties.description === 'string' && !meta.description) meta.description = properties.description;
