...
const runCodeSchema: Tool = {
	...
	function: {
		...
		description:
			...
			'`turf` (a curated @turf/turf subset: circle, distance, buffer, area, length, bearing, destination, point, lineString, multiLineString, along, nearestPointOnLine, booleanPointInPolygon, centroid, bbox, bboxPolygon, booleanIntersects, cleanCoords, difference, explode, featureCollection, intersect, lineSlice, nearestPoint, polygonToLine, simplify, union), ' +
