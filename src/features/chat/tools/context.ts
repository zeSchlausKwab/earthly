...
function createLegacyMapContextSystemMessage(
	...
	return {
		...
		content: [
			...
			'Only after query_geography confirms a coverage gap: for many OSM features in an area, use one bounded import_osm_to_editor call with filters and bbox/point instead of embedding large GeoJSON argument strings.',
			'Only after a confirmed catalog gap: use query_osm_area for polygon-constrained OSM searches, and always include filters, filterSets, or concept.',
