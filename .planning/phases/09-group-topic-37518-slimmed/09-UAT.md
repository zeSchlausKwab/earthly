...
updated: 2026-06-25T14:10:00Z
---

## Current Test

number: 1
name: Group authoring flow (GROUP-01)
expected: |
  The RadioGroup renders 3 Card-bodied governance cards with verbatim UI-SPEC one-liners;
  selecting 'Schema' reveals the builder/advanced schema section; selecting away from 'Schema'
  strips the schema fields; clicking Save publishes the Group (verify in the relay / Groups list);
  editing re-saves in place (same d-tag, not a new entry).
